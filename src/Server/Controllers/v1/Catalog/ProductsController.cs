...
using MVWorkflows.Application.Features.Products.Commands.Delete;
using MVWorkflows.Application.Features.Products.Queries.Export;
using MVWorkflows.Application.Features.Products.Queries.GetAllPaged;
using MVWorkflows.Application.Features.Products.Queries.GetProductImage;
using MVWorkflows.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace MVWorkflows.Server.Controllers.v1.Catalog
{
