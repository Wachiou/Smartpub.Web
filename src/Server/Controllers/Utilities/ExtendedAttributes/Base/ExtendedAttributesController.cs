...
using MVWorkflows.Application.Features.ExtendedAttributes.Commands.Delete;
...
using MVWorkflows.Application.Features.ExtendedAttributes.Queries.GetById;
using MVWorkflows.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace MVWorkflows.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
