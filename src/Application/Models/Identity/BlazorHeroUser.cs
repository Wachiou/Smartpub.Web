...
namespace MVWorkflows.Application.Models.Identity
{
    public class BlazorHeroUser : IdentityUser<string>, IChatUser, IAuditableEntity<string>, IRHMoovProperties
    {
        ...
        public int JoursDeCongeRestantAvant { get; set; }
