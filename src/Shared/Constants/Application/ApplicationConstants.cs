namespace MVWorkflows.Shared.Constants.Application
{
    public static class ApplicationConstants
    {
        ...
        public static class Cache
        {
            ...
            public const string GetAllWorkflowsCacheKey = "all-workflows";
            public const string GetAllGroupementCacheKey = "all-groupement";
            public const string GetAllTypeGroupementCacheKey = "all-typegroupement";
